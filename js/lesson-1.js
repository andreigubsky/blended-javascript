...
// function checkQuarter(param) {
//     if(min<=10){
//         alert(`${param} входить в першу чверть`)
...
//         alert(`${min} входить в п'яту чверть`)
//     }else if(param>50 && param<=60){
//         alert(`${param} входить в шосту чверть`)
//     }
// console.log(param);
// }
// checkQuarter(min)
...
//             sumOfEvenNumbers += i; // Добавляем к сумме, если оно четное
//         }
//     }
